...
class InstanceTemplateCreatorConfig:
    ...
    network: str = "https://www.googleapis.com/compute/v1/projects/cybulde-427611/global/networks/default"
    subnetwork: str = "https://www.googleapis.com/compute/v1/projects/cybulde-427611/regions/asia-south1/subnetworks/default"
    startup_script_path: str = "scripts/vm_startup/task_runner.sh"
    ...
    labels: dict[str, str] = field(default_factory=lambda: {"project": "cybulde-42761"})
